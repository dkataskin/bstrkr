...
namespace bstrkr.core.android.views.adapters
{
	public class MvxViewPagerFragmentAdapter : FragmentPagerAdapter
	{
		...
		public override Fragment GetItem(int position)
		{
			...
			var fragment = Fragment.Instantiate(_context, this.FragmentJavaName(frag.FragmentType));
		...
		{ 
			return new Java.Lang.String(this.Fragments.ElementAt(p0).Title); 
		}
	}
}